    ...
    _createClass(ChatBubble, [{
        ...
        value: function render() {
            ...
            if (this.props.message.timestamp) {
                return React.createElement(rebass_1.Tooltip, { style: { zIndex: 1000 }, text: moment(this.props.message.timestamp).fromNow() }, React.createElement("div", { style: Object.assign({}, styles_1.default.chatbubbleWrapper, { overflow: "visible" }) }, React.createElement("div", { style: chatBubbleStyles }, React.createElement("p", { style: Object.assign({}, styles_1.default.p, text) }, this.props.message.message))));
            }
